    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 space-y-10">
      ...
      <div className="text-left">
        <h2 className="text-2xl font-bold">
          What is Fine-Grained Non-Proliferative Diabetic Retinopathy?
        </h2>
        <p className="text-gray-600 text-left">
          It’s the early stage of the disease, where damage to the retina ’ s
          tiny blood vessels is new and fine-grained and abnormal blood vessels
          have not yet started to grow is known as fine-grained
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {stages.map((stage, index) => (
            <StageCard key={index} title={stage.title} imageSrc={stage.img} />
          ))}
        </div>
      </section>
      ...
      <section>
        <div className="flex justify-between items-end mb-8">
          ...
          <Link
            href="#"
            className="text-[#3B8FAB] text-sm font-bold hover:underline mb-1"
          >
            View All &gt;
          </Link>
        </div>
